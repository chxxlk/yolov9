...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from utils.general import LOGGER, check_requirements, intersect_dicts, logging, torch_load_compat
    ...
    try:
        ...
        if pretrained and channels == 3 and classes == 80:
            ...
            if pretrained:
                ckpt = torch_load_compat(attempt_download(path), map_location=device)  # load
